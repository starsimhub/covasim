...
- [`plans/2026-05-29-covasim-m4-waning-nabs.md`](./plans/2026-05-29-covasim-m4-waning-nabs.md) / [`specs/2026-05-29-covasim-m4-waning-nabs-design.md`](./specs/2026-05-29-covasim-m4-waning-nabs-design.md) — M4 waning-immunity + NAbs plan + design spec (`use_waning` gates the M3-static vs NAb-weighted cross-immunity; re-converges the M3 divergence).
- [`plans/2026-05-29-covasim-m5-testing-tracing-quarantine.md`](./plans/2026-05-29-covasim-m5-testing-tracing-quarantine.md) / [`specs/2026-05-29-covasim-m5-testing-tracing-quarantine-design.md`](./specs/2026-05-29-covasim-m5-testing-tracing-quarantine-design.md) — M5 testing/tracing/quarantine plan + design spec.
- [`plans/2026-05-30-covasim-m6-vaccination.md`](./plans/2026-05-30-covasim-m6-vaccination.md) / [`specs/2026-05-30-covasim-m6-vaccination-design.md`](./specs/2026-05-30-covasim-m6-vaccination-design.md) — M6 vaccination plan + design spec (vaccines on the M4 NAb pipeline; `max(natural, vaccine)` immunity).
- [`specs/2026-05-30-covasim-m7-calibration-fit-design.md`](./specs/2026-05-30-covasim-m7-calibration-fit-design.md) / [`plans/2026-05-30-covasim-m7-calibration-fit.md`](./plans/2026-05-30-covasim-m7-calibration-fit.md) — M7 Calibration + Fit (cv.Fit on the flat-results bridge; cv.Calibration on Optuna ss.Calibration).
- [`specs/2026-05-30-covasim-m8-multisim-scenarios-design.md`](./specs/2026-05-30-covasim-m8-multisim-scenarios-design.md) — M8 MultiSim/Scenarios/parallel design+plan (cv.MultiSim UQ + cv.Scenarios on ss.MultiSim).
