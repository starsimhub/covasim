...
Note that this project is released with a [Contributor Code of Conduct](https://github.com/InstituteforDiseaseModeling/covasim/blob/master/CODE_OF_CONDUCT.rst). By participating in this project you agree to abide by its terms.
...
> - [Project README](https://github.com/InstituteforDiseaseModeling/covasim/blob/master/README.rst): Setup and project overview.
> - [Covasim README](https://github.com/InstituteforDiseaseModeling/covasim/blob/master/covasim/README.rst): Simulation parameters. application. docker setup.
> - [Tests README](https://github.com/InstituteforDiseaseModeling/covasim/blob/master/tests/README.rst): Running tests locally.
...
2.  Install Covasim on your machine. See the [project README](https://github.com/InstituteforDiseaseModeling/covasim/blob/master/README.rst).
